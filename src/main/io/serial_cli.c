...
const clivalue_t valueTable[] = {
    ...
    { "beeper_off_vbat_min",        VAR_UINT8  | MASTER_VALUE, &masterConfig.beeper_off.vbat_min, 0, 255 },
    { "beeper_off_vbat_max",        VAR_UINT8  | MASTER_VALUE, &masterConfig.beeper_off.vbat_max, 0, 255 },
};
